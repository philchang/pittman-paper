...
\caption{Tracking plot for density and associated pdf graphs for two regions.  The density graphs have slopes of -3/2, -2, and -5/2 shown for reference.  The upper density frame on the left shows a consistent slope matching the -3/2 reference line very nicely.  The pdf graphs show three volumes, one at 1pc, one at 2pc, and one at 5pc.  \label{fig:Track_and_pdf_000}}
\end{figure*}

\begin{figure*}
\plottwo{Track_0132_002_rho.png}{pdf_frame_0132_0002.png}
\plottwo{Track_0132_002_vr.png} {Track_0132_002_mass.png}
\caption{Tracking plot for density and associated pdf graphs for two regions.  The density graphs have slopes of -3/2, -2, and -5/2 shown for reference.  The upper density frame on the left shows a consistent slope matching the -3/2 reference line very nicely.  The pdf graphs show three volumes, one at 1pc, one at 2pc, and one at 5pc.  \label{fig:Track_and_pdf_002}}
\end{figure*}
